...
import com.clientui.clientui.proxies.MicroservicePayinProxy;
...
public class ClientController {
    ...
    @Autowired
    private MicroservicePayinProxy payinProxy;
    ...
    @RequestMapping(value="/commander-produit/{idProduit}/{prix}")
    public String commander(@PathVariable int idProduit, @PathVariable Double prix, Model model){
        ...
        model.addAttribute("montant", prix);
    ...
    public String payerCommande(@PathVariable int idCommande, @PathVariable Double montantCommande, Model model){
        ...
        PayBean paiementAExcecuter = new PayBean();
        ...
        ResponseEntity<PayBean> paiement = payinProxy.payerUneCommande(paiementAExcecuter);
